...
(function (global, factory) {
	...
	})(exports.MotorDriveType || (exports.MotorDriveType = {}));
	/**
	 * The drive type selection for the motor
	 * @public
	 */
	...
	exports.MotorPositionType = void 0;
	...
	})(exports.MotorPositionType || (exports.MotorPositionType = {}));
	/**
	        ...
	        this._ws.onmessage = event => {
	          try {
	            ...
	            if (this.onError) {
	              ...
	              try {
	                this.onError(exports.ErrorCode.UNEXPECTED, msg);
	              } catch (err) {
	                logEventException(err);
	              }
